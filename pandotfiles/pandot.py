...
def main():
    ...
    if args.command == 'init':
        ...
        for option in option_list:
            ...
            if option not in VALIDOPTIONINIT:
                ...
                try:
                    ...
                    with open(str(xdg_data_home()) +
                              '/pandot/gitignore/doc.gitignore') as file:
                        gitignore = file.read()
                ...
                try:
                    file_output = open(srcdir+"/.gitignore", 'x')
                    with open(str(xdg_data_home()) +
                              '/pandot/gitignore/tikz.gitignore') as file:
                        gitignore = file.read()
                    file_output.write(gitignore)
                    file_output.close()
                except FileExistsError:
                ...
                try:
                    file_output = open(srcdir+"/.gitignore", 'x')
                    with open(str(xdg_data_home()) +
                              '/pandot/gitignore/python.gitignore') as file:
                        gitignore = file.read()
                    file_output.write(gitignore)
                    file_output.close()
                except FileExistsError:
                ...
                try:
                    ...
                    with open(str(xdg_data_home()) +
                              '/pandot/defaults/environment.yaml') as file:
                ...
                with open(str(xdg_data_home())+
                    ...
                    makefile = file.read()
                makefile = sub(r'(builddir\s=)(.*)',
                               '\\1 ../../' + str(builddir), makefile)
                makefile = sub(r'(outputdir\s=)(.*)',
                               '\\1 ' + str(outputdir), makefile)
                ...
                try:
                    file_output = open(srcdir+"/.gitignore", 'x')
                    with open(str(xdg_data_home()) +
                              '/pandot/gitignore/codev.gitignore') as file:
                        gitignore = file.read()
                    file_output.write(gitignore)
                    file_output.close()
                except FileExistsError:
        ...
        try:
            ...
            with open(str(xdg_data_home()) +
                      '/pandot/gitignore/project.gitignore') as file:
                gitignore = file.read()
            file_output.write(gitignore)
            file_output.close()
        except FileExistsError:
        ...
        if args.option not in VALIDOPTIONNEWFILE:
            ...
            try:
                with open(filename+".py", 'x') as file_output:
                    file_output.write("#!/usr/bin/env conda run -p "
                                      "../../build/python/env ipython")
                    file_output.close()
            except FileExistsError:
